    ...
    public void InitalLizeListenner()
    {
        callbackMethon = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                editText.setText("https://www.kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=573f280a832e6d2cea4e34332ead9929&targetDt="+date);
            }
        };
    }
